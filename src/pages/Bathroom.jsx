...
const styles = {
  ...
  boxes: {
    ...
    backgroundImage: "url('public/assets/bathroom01.webp')",
  ...
  box1: {
    ...
    justifyContent: "center",
    alignItems: "flex-end",
    backgroundImage: "url('public/assets/bathroom 03.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box2: {
    ...
    justifyContent: "center",
    alignItems: "flex-end",
    backgroundImage: "url('public/assets/bathroom05.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box3: {
    ...
    justifyContent: "center",
    alignItems: "flex-end",
    backgroundImage: "url('public/assets/bathroom04.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box4: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/bathroom02.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box5: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/bathroom06.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
