...
const styles = {
  ...
  boxes: {
    ...
    backgroundImage: "url('public/assets/living-room-01.webp')",
  ...
  box1: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/smart-living-room.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box2: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/smart-switch-03.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box3: {
    ...
    justifyContent: "center",
    alignItems: "flex-end",
    backgroundImage: "url('public/assets/smart-climate-04.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box4: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/smart-home-05.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box5: {
    ...
    justifyContent: "center",
    alignItems: "flex-end",
    backgroundImage: "url('public/assets/smart-curtain-06.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
  ...
  box6: {
    ...
    justifyContent: "center",
    alignItems: "flex-start",
    backgroundImage: "url('public/assets/smart-locks-07.webp')",
    backgroundSize: "cover",
    backgroundPosition: "center",
    padding: "clamp(70px, 10vw, 120px) clamp(20px, 6vw, 80px)",
    boxSizing: "border-box",
